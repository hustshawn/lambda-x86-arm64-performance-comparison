...
class TestLambdaPerformanceTester(unittest.TestCase):
    ...
    def test_calculate_statistics(self):
        ...
        results = [
            TestResult(
                architecture='arm64', function_name='test-arm64', operation='sort',
                data_size=100, iterations=1, execution_time_ms=100.0, memory_used_mb=50.0,
                cold_start=False, timestamp='2024-01-01T00:00:00', status='success'
            ),
            TestResult(
                architecture='arm64', function_name='test-arm64', operation='sort',
                data_size=100, iterations=1, execution_time_ms=120.0, memory_used_mb=55.0,
                cold_start=True, timestamp='2024-01-01T00:01:00', status='success'
            ),
            TestResult(
                architecture='x86_64', function_name='test-x86', operation='sort',
                data_size=100, iterations=1, execution_time_ms=110.0, memory_used_mb=60.0,
                cold_start=False, timestamp='2024-01-01T00:02:00', status='success'
            ),
            TestResult(
                architecture='x86_64', function_name='test-x86', operation='sort',
                data_size=100, iterations=1, execution_time_ms=130.0, memory_used_mb=65.0,
                cold_start=True, timestamp='2024-01-01T00:03:00', status='success'
            )
        ]
    ...
    def test_compare_architectures(self):
        ...
        stats = [
            PerformanceStats(
                architecture='arm64', operation='sort', data_size=100, sample_count=5,
                mean_execution_time=100.0, median_execution_time=98.0, std_dev_execution_time=5.0,
                min_execution_time=90.0, max_execution_time=110.0, mean_memory_usage=50.0,
                cold_start_percentage=20.0
            ),
            PerformanceStats(
                architecture='x86_64', operation='sort', data_size=100, sample_count=5,
                mean_execution_time=120.0, median_execution_time=118.0, std_dev_execution_time=8.0,
                min_execution_time=105.0, max_execution_time=135.0, mean_memory_usage=60.0,
                cold_start_percentage=20.0
            )
        ]
        ...
        self.assertAlmostEqual(comparison['execution_time_diff_percent'], -16.67, places=1)
